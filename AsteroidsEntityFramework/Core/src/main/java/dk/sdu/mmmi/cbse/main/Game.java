...
public class Game
    ...
    public void create() {
        ...
        for (int i = 0; i < 10; i++) {
            world.addEntity(SPILocator.locateAll(AsteroidSPI.class).get(0).createAsteroid((float) Math.random() * gameData.getDisplayHeight(), (float) Math.random() * gameData.getDisplayWidth()));
        }
